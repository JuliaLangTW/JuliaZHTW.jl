...
makedocs(
    ...
    pages = [
        ...
        "Base" => [
            "Essentials" => "base/base.md",
            "Collections and Data Structures" => "base/collections.md",
            "Mathematics" => "base/math.md",
            "Numbers" => "base/numbers.md",
            "Strings" => "base/strings.md",
            "Arrays" => "base/arrays.md",
            "Tasks" => "base/parallel.md",
            "Multi-Threading" => "base/multi-threading.md",
            "Constants" => "base/constants.md",
            "Filesystem" => "base/file.md",
            "I/O and Network" => "base/io-network.md",
            "Punctuation" => "base/punctuation.md",
            "Sorting and Related Functions" => "base/sort.md",
            "Iteration utilities" => "base/iterators.md",
            "C Interface" => "base/c.md",
            "C Standard Library" => "base/libc.md",
            "StackTraces" => "base/stacktraces.md",
            "SIMD Support" => "base/simd-types.md",
        ],
        "標準程式庫" => [
        ],
        "開發者手冊" => [
